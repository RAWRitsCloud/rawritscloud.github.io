...
The logic App I host in Azure costs less than a 1p a month to run every single day, I have a simple Trigger at 6pm. I've uploaded the full template to a [Git Repo](https://github.com/RAWRitsCloud/blog-content/tree/main/automating-your-blog), however I've snipped it up into little bits in this blog.
